...
class TestLibrary(unittest.TestCase):
    ...
    def setUp(self):
        ...
        self.library.books = [
            Book(book_id=1, title="Война и мир", author="Лев Толстой", year=1867, status="в наличии"),
            Book(book_id=2, title="Анна Каренина", author="Лев Толстой", year=1873, status="выдана"),
            Book(book_id=3, title="Мёртвые души", author="Николай Гоголь", year=1842, status="в наличии"),
        ]
